...
public class FileBackedTaskManager extends InMemoryTaskManager {
    ...
    private void fromString(String value) {
         ...
         switch (fields[1]) {
             case "TASK":
                 Task task = new Task(fields[2], fields[4], fields[5], Long.parseLong(fields[6]));
                 addTask(task);
             ...
             case "SUBTASK":
                 SubTask subTask = new SubTask(fields[2], fields[4], fields[5], Long.parseLong(fields[6]));
    ...
    public String historyToString(HistoryManager manager) {
        return manager.getHistoryList().toString();
    }
    ...
    private void save() {
        try (BufferedWriter writer = Files.newBufferedWriter(filePath)) {
            ...
            for (var task : historyManager.getHistoryList()) {
                writer.write(task.toString() + "\n");
            }
        } catch (IOException e) {
